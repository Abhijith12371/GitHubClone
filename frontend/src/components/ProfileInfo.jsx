...
const ProfileInfo = ({ userProfile }) => {
    // console.log("Personal", userProfile);
    ...
    return (
        <div className='lg:w-1/3 w-full flex flex-col gap-4 md:sticky md:top-10'>
            ...
            <div className='flex flex-wrap gap-4 mx-0 md:mx-4'>
                {/* Followers Count */}
                <div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1 min-w-[120px]'>
